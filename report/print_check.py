...
class report_check_voucher(osv.AbstractModel):
    _name = 'report.globpak.report_check_voucher'
    _inherit = 'report.abstract_report'
    _template = 'globpak.report_check_voucher'
    _wrapped_report_class = report_print_check

# class print_check_middle(osv.AbstractModel):
#     _name = 'report.globpak.print_check_middle'
#     _inherit = 'report.abstract_report'
#     _template = 'globpak.print_check_middle'
#     _wrapped_report_class = report_print_check

# class print_check_bottom(osv.AbstractModel):
#     _name = 'report.globpak.print_check_bottom'
#     _inherit = 'report.abstract_report'
#     _template = 'globpak.print_check_bottom'
#     _wrapped_report_class = report_print_check
