...
class AccountReportAssetSummary(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        return {
            ...
            'url': '/web/export_xls/asset_summary?filename=%s&title=%s&company_id=%s&date_from=%s&date_to=%s&account_id=%s'%(filename,title,company_id,date_from,date_to,account_id),
            'target': 'self',
        }                     
